    ...
    <div className="bg-surface-container-lowest rounded-lg shadow p-10 flex flex-col items-center gap-8 w-full max-w-sm">
      ...
      <div className="text-center">
        <h1 className="font-manrope font-semibold text-2xl text-on-surface">
          Sign in to <b>EasyStaff</b>
        </h1>
        <p className="text-sm text-on-surface-variant mt-1">
          Automate your salary calculations with ease
        </p>
      </div>
      ...
      <div className="w-full flex flex-col gap-3">
        <button
          ...
          className="w-full flex items-center justify-center gap-3 border border-outline-variant rounded-md py-2.5 px-4 text-sm font-medium text-on-surface hover:bg-surface-container-high transition-colors"
        >
