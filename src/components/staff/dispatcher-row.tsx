 ...
 * what the eye reads.
 */
export const ROW_GRID = "grid grid-cols-[1.6rem_1.6fr_0.55fr_1fr_1.1fr_4px_0.4fr_0.6fr_1.1fr_4px_0.4fr_0.6fr_1.1fr_0.4fr_0.5fr] items-center gap-x-1.5 min-w-[1280px]";
  ...
  return (
    <div className={`${ROW_GRID} px-5 py-[0.6rem] ${
      ...
      <div className="flex items-center gap-2 min-w-0">
        ...
        >
          <p
            className="text-[0.82rem] font-medium text-on-surface uppercase leading-tight line-clamp-2 break-normal"
            title={dispatcher.name}
          >
            {dispatcher.name}
          </p>
          <p className="text-[0.66rem] text-on-surface-variant mt-0.5">{dispatcher.extId}</p>
        </button>
      </div>
